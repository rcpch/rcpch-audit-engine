...
class S01(models.Model):
    ...
    S01OptOut=models.CharField(max_length=2, choices=(("Y","Yes"),("N", "No")))
    S01OptOutDate=models.DateField()
    S01FollowUpEpisodes=models.CharField(max_length=2, choices=(("Y","Yes"),("N", "No")))
    S01FollowUpEpisodesStatus=models.IntegerField(choices=((1, "Discharged and transferred to another paediatric provider"), (2, "Transferred to adult services"), (3, "Discharged to GP because ongoing paediatric follow up not required"), (7, "Discharged to GP because DNA/was not brought/Cancelled"), (4, "Followed up by paediatrics but not because of epileptic non-epileptic or uncertain episodes"), (5, "No ongoing follow up for other reason"), (6, "Died")))
    ...
    S01NeonatalSeizures=models.CharField(max_length=2,choices=(("Y","Yes"),("N", "No"),("U","Uncertain")))
    S01FebrileSeizure=models.CharField(max_length=2,choices=(("Y","Yes"),("N", "No"),("U","Uncertain")))
    S01AcuteSymptomaticSeizure=models.CharField(max_length=2,choices=(("Y","Yes"),("N", "No"),("U","Uncertain")))
    S01DiagnosticStatus=models.CharField(max_length=2,choices=(("a","The child has had an episode or episodes where one or more are considered epileptic"), ("b","The child has had an episode or episodes that are considered non-epileptic only"),("c", "The child has had an episode or episodes where there remains uncertainty whether episodes were epileptic or not.")))
    S01DescribeTheEpisode=models.CharField(max_length=2,choices=(("a","This was a single episode"), ("b", "This was a cluster within 24 hours"),("c","These were 2 or more episodes more than 24 hours apart"),("d","The patient was diagnosed as having epilepsy for another reason")))
    S01EPIS=models.CharField(max_length=2)
    EPISSectionStatus=models.CharField(max_length=2, choices=SECTION_STATUS_CHOICES)
    EPISType=models.IntegerField(choices=((1,"Syncope And Anoxic Seizures"),(2,"Behavioral Psychological And Psychiatric Disorders"),(3, "Sleep Related Conditions"), (4,"Paroxysmal Movement Disorders"), (5, "Migraine Associated Disorders"), (6,"Miscellaneous Events"),(7, "Other")))
    EPISSyncope=models.CharField(max_length=3, choices=(("a", "Vasovagal syncope"), ("b", "Reflex anoxic seizures"), ("c", "Breath-holding attacks"), ("d", "Hyperventilation syncope"), ("e", "Compulsive valsalva"), ("f", "Neurological syncope"),("g", "Imposed upper airways obstruction"), ("h", "Orthostatic intolerance"), ("i", "Long QT and cardiac syncope"), ("j", "Hyper-cyanotic spells")))
    EPISBehavioral=models.CharField(max_length=3, choices=(("a", "Daydreaming /inattention"), ("b", "Infantile gratification"), ("c", "Eidetic imagery"), ("d", "Tantrums and rage reactions"), ("e", "Out of body experiences"), ("f", "Panic attacks"), ("g", "Dissociative states"), ("h", "Non-epileptic seizures"), ("i", "Hallucinations in psychiatric disorders"), ("j","Fabricated / factitious illness")))
    EPISSleep=models.CharField(max_length=3, choices=(("a","Sleep related rhythmic movement disorders"), ("b","Hypnogogic jerks"),("c","Parasomnias"), ("d", "REM sleep disorders"), ("e", "Benign neonatal sleep myoclonus"), ("f", "Periodic leg movements"), ("g", "Narcolepsy-cataplexy")))
    EPISParoxysmal=models.CharField(max_length=3, choices=(("a","Tics"), ("b","Stereotypies"), ("c", "Paroxysmal kinesigenic dyskinesia"), ("d", "Paroxysmal nonkinesigenic dyskinesia"),("e", "Paroxysmal exercise induced dyskinesia"), ("f", "Benign paroxysmal tonic upgaze"), ("g", "Episodic ataxias"), ("h", "Alternating hemiplegia"), ("i", "Hyperekplexia"), ("j", "Opsoclonus-myoclonus syndrome")))
    EPISMigraine=models.CharField(max_length=3, choices=(("a", "Migraine with visual aura"),("b", "Familial hemiplegic migraine"),("c", "Benign paroxysmal torticollis"), ("d", "Benign paroxysmal vertigo"), ("e", "Cyclical vomiting")))
    EPISMiscellaneous=models.CharField(max_length=3, choices=(("a", "Benign myoclonus of infancy and shuddering attacks"), ("b", "Jitteriness"), ("c", "Sandifer syndrome"),("d", "Non-epileptic head drops"), ("e", "Spasmus nutans"), ("f", "Raised intracranial pressure"), ("g", "Paroxysmal extreme pain disorder"), ("h", "Spinal myoclonus")))
    EPISOther=models.CharField(max_length=250)
    S01Notes=models.CharField(max_length=250)
    S01NHSPatient=models.CharField(max_length=2, choices=(("Y","Yes"),("N", "No")))
    ...
    S01Gender=models.CharField(max_length=3, choices=(("M", "Male"), ("F", "Female"), ("NK", "Not known")))
    S01DOB=models.DateField()
    S01FirstEEG=models.CharField(max_length=2, choices=(("Y","Yes"),("N", "No")))
    S01FirstEEGDate=models.DateField()
    S01FirstEEGIndicated=models.CharField(max_length=2, choices=(("Y","Yes"),("N", "No")))
    S01AssessmentForTheParoxysmalHere=models.CharField(max_length=2, choices=(("Y","Yes"),("N", "No")))
    S01ReferringHospital=models.CharField(max_length=150)
    S01ReferringPerson=models.CharField(max_length=150)
    S01TrustVerify=models.CharField(max_length=3, choices=(("REG", "Registered"), ("VFD", "Trust Verified"), ("NYV", "Not yet verified"), ("EX1", "Excluded (Registration)"),("EX2", "Excluded (Verification)"), ("POO", "Patient opt out")))
    S01DiagnosisStatus=models.CharField(max_length=3, choices=(("E", "Epilepsy"), ("NE", "Non-epilepsy"), ("U", "Uncertain")))
...
class S02(models.Model):
    ...
    S02ParoxysmalEpisode=models.CharField(max_length=2, choices=(("Y","Yes"),("N", "No")))
    S02EEGAssessments=models.CharField(max_length=2, choices=(("Y","Yes"),("N", "No")))
...
class S03(models.Model):
    ...
    S03StatusPaediatricNeurologyFollowUp=models.IntegerField(choices=(("a", "Ongoing input"), ("b", "Previous input"), ("c", "Uncertain"), ("d", "None")))
    ...
    S03CurrentStatusOfEpilepsySurgeryService=models.CharField(max_length=2, choices=(("a", "Ongoing input"), ("b", "Previous input"), ("c", "Uncertain"), ("d", "None")))
    ...
    S03FormChecked=models.IntegerField(choices=((1, "Checked"), (2,"Unchecked")))

class S04(models.Model):
    S04SectionStatus=models.CharField(max_length=2, choices=SECTION_STATUS_CHOICES)
    S04ServiceChildReferredForFirstAssessment=models.CharField(max_length=2, choices=((1, "ED"), (2, "GP"), (3, "Health Visitor"), (4, "Outpatient paediatrics"), (5, "Inpatient paediatrics"), (6, "PICU"), (7, "Neonatal care"), (8, "Other")))
    ...
    S04DateOfReferralToPaediatrics_NK=models.IntegerField(choices=((1, "Checked"), (2,"Unchecked")))
    S04FirstPaediatricAssessmentAcuteOrNonAcute=models.CharField(max_length=2, choices=((1, "Acute"), (2, "Non-acute"), (3, "Don't know")))
    S04ADescriptionOfTheEpisodeOrEpisodes=models.CharField(max_length=2, choices=(("Y","Yes"),("N", "No")))
    S04WhenTheFirstEpilepticEpisodeOccurredApxExcNK=models.CharField(max_length=3, choices=(("Apx", "Approximate date"), ("Exc", "Exact date"), ("NK", "Not known")))
    S04WhenTheFirstEpilepticEpisodeOccurred=models.DateField()
    S04FrequencyOrNumberOfEpisodesSinceTheFirstEpisode=models.CharField(max_length=2, choices=(("Y","Yes"),("N", "No")))
    S04AGeneralExamination=models.CharField(max_length=2, choices=(("Y","Yes"),("N", "No")))
    S04ANeurologicalExamination=models.CharField(max_length=2, choices=(("Y","Yes"),("N", "No")))
    S04DevelopmentalLearningOrSchoolingProblems=models.CharField(max_length=2, choices=(("Y","Yes"),("N", "No")))
    S04BehaviouralOrEmotionalProblems=models.CharField(max_length=2, choices=(("Y","Yes"),("N", "No")))
    S04Comments=models.CharField(max_length=250)
    S04FormChecked=models.IntegerField(choices=((1, "Checked"), (2,"Unchecked")))
...
class S05(models.Model):
    ...
    S05WereAnyOfTheEpilepticSeizuresConvulsive=models.CharField(max_length=2, choices=(("Y","Yes"),("N", "No")))
    S05ProlongedGeneralizedConvulsiveSeizures=models.CharField(max_length=3, choices=(("M", "Male"), ("F", "Female"), ("U", "Uncertain")))
    S05ExperiencedProlongedFocalSeizures=models.CharField(max_length=3, choices=(("M", "Male"), ("F", "Female"), ("U", "Uncertain")))
    S05IsThereAFamilyHistoryOfEpilepsy=models.CharField(max_length=3, choices=(("M", "Male"), ("F", "Female"), ("N", "Not Assessed")))
    S05IsThereAFamilyHistoryOfEpilepsyNotes=models.CharField(max_length=250)
    S05FormChecked=models.IntegerField(choices=((1, "Checked"), (2,"Unchecked")))
    S05CAUSSectionStatus=models.CharField(max_length=2, choices=SECTION_STATUS_CHOICES)
    S05CAUSDateCauseApxExcNK=models.CharField(max_length=3,choices=(("Apx","Approximate date"),("Exc","Exact date"), ("NK", "Not known")))
    S05CAUSDateCause=models.DateField()
    S05CAUSMain=models.CharField(max_length=3, choices=(("Str", "Structural"), ("Gen", "Genetic"), ("Inf", "Infectious"), ("Met", "Metabolic"), ("Imm", "Immune"), ("NK", "Not known")))
    S05CAUSSubStructural=models.CharField(max_length=3, choices=(("TbS", "Tuberous Sclerosis"), ("StW", "Sturge Weber"), ("FCD","Focal cortical dysplasia"), ("HyH", "Hypothalamic Hamartoma"), ("LGT","Low grade tumour"), ("TuO","Tumour (other)"), ("MCD", "Malformations of Cortical Development"), ("Vas" , "Vascular (eg arterial ischaemic stroke venous ischaemia cerebral haemorrhage)"), ("TBI", "Traumatic brain injury"), ("NR", "Not required")))
    S05CAUSSubGenetic=models.CharField(max_length=3, choices=(("DrS","Dravet syndrome"), ("GTD","Glucose Transporter Defect"), ("AnS", "Angelman Syndrome"), ("ReS", "Rett Syndrome"), ("ChA", "Chromosomal abnormality"),("GeA", "Gene abnormality")))
    S05CAUSSubGeneticChromoAbno=models.CharField(max_length=200)
    S05CAUSSubGeneticGeneAbno=models.CharField(max_length=3, choices=(("UBE","UBE3A"), ("GLU", "GLUT1"), ("SLC", "SLC2A1"), ("MEC", "MECP2"), ("SCN", "SCN1A"), ("STX", "STXBP1"), ("CDK", "CDKL5"), ("KCN", "KCNQ2"), ("SCN", "SCN2A"), ("KCN", "KCNT1"), ("ARX", "ARX"), ("FOX", "FOXG1"), ("PCD", "PCDH19"), ("GRI", "GRIN2A"), ("Oth", "Other")))
    S05CAUSSubGeneticGeneAbnoOther=models.CharField(max_length=250)
    S05CAUSSubInfectious=models.CharField(max_length=250)
    S05CAUSSubMetabolic=models.CharField(max_length=3, choices=(("Mit", "Mitochondrial disorder"), ("Neu", "Neuronal Ceroid Lipofuscinosis (Batten Disease)"), ("PPM", "Disorder of pyridoxine/pyridoxal phosphate metabolism"), ("BiM", "Disorder of biotin metabolism"), ("CrM", "Disorder of creatine metabolism"), ("AmA", "Disorder of amino acid"), ("UrA", "Disorder of urea cycle"), ("PyP", "Disorder of pyrimidine and purine"), ("Cho", "Disorder of cholesterol"), ("Oth", "Other neurometabolic disorder")))
    S05CAUSSubMetabolicOther=models.CharField(max_length=250)
    S05CAUSSubImmune=models.CharField(max_length=3, choices=(("RaE", "Rasmussen Encephalitis"), ("AnM", "Antibody mediated")))
    S05CAUSSubImmuneAntibody=models.CharField(max_length=3,choices=(("VGK", "VGKC"), ("NMD", "NMDAR"), ("GAD", "GAD"), ("TPO", "TPO"), ("MOG", "MOG"), ("Oth", "Other")))
    ...
    S05MHPBDateNeurodevelopmentalProblemApxExcNK=models.CharField(max_length=3, choices=(("Apx", "Approximate date"), ("Exc", "Exact date"), ("NK", "Not known")))
    S05MHPBDateNeurodevelopmentalProblem=models.DateField()
    S05MHPBMentalHealthProblem=models.CharField(max_length=3,choices=(("MoD", "Mood disorder"), ("AxD", "Anxiety disorder"), ("EmB", "Emotional/ behavioural"), ("SHm", "Self harm"), ("Oth", "Other")))
    S05MHPBMentalHealthProblemOther=models.CharField(max_length=250)
    S05MHPBMentalHealthProblemEmotional=models.CharField(max_length=3, choices=(("CnD", "Conduct disorder"), ("ODD", "Oppositional Defiant Disorder (ODD)")))
    S05NUDSSectionStatus=models.CharField(max_length=2, choices=SECTION_STATUS_CHOICES)
    S05NUDSDateNeurodevelopmentalProblemApxExcNK=models.CharField(max_length=3, choices=(("Apx", "Approximate date"), ("Exc", "Exact date"), ("NK", "Not known")))
    S05NUDSDateNeurodevelopmentalProblem=models.DateField()
    S05NUDSNeurodevelopmentalProblem=models.CharField(max_length=3, choices=(("ASD", "Autistic spectrum disorder"), ("CeP", "Cerebral palsy"), ("NDC", "Neurodegenerative disease or condition"), ("ChD", "An identified chromosomal disorder with a neurological or developmental component"), ("ADH", "Attention deficit hyperactivity disorder"), ("Int", "intellectual disability/global development delay/'learning disability'"), ("Dsp", "dyspraxia"), ("Dsl", "dyslexia"), ("SDo", "speech disorder"), ("Oth", "other learning difficulty")))
    S05NUDSNeurodevelopmentalProblemOther=models.CharField(max_length=250)
    S05NUDSNeurodevelopmentalProblemSeverity=models.CharField(max_length=3,choices=(("Mil", "Mild"), ("Mod", "Moderate"), ("Sev", "Severe"), ("Pro", "Profound")))
    S05SEIZSectionStatus=models.CharField(max_length=2, choices=SECTION_STATUS_CHOICES)
    S05SEIZDateOfOnsetApproxExactNK=models.CharField(max_length=3, choices=(("Apx", "Approximate date"), ("Exc", "Exact date"), ("NK", "Not known")))
    S05SEIZDateOfOnset=models.DateField()
    S05SEIZDescriptionOfEvent=models.CharField(max_length=250)
    S05SEIZEpilepticOrNonEpilepticOrUncertain=models.CharField(max_length=3,choices=(("Ep", "Epileptic"), ("NEp", "Non-epileptic"), ("Unc", "Uncertain")))
    S05SEIZEpilepticSeizureType=models.CharField(max_length=3,choices=(("FO", "Focal onset"), ("GO", "Generalised onset"), ("UO", "Unknown onset"), ("UC", "Unclassified")))
    S05SEIZNonEpilepticSeizureType=models.CharField(max_length=3,choices=(("SAS", "Syncope And Anoxic Seizures"), ("BPP", "Behavioral Psychological And Psychiatric Disorders"), ("SRC", "Sleep Related Conditions"), ("PMD", "Paroxysmal Movement Disorders"), ("MAD", "Migraine Associated Disorders"), ("ME", "Miscellaneous Events"), ("Oth", "Other")))
    S05SEIZEpilepticSeizureTypeFOImpAware=models.IntegerField(choices=((1, "Checked"), (2,"Unchecked")))
    S05SEIZEpilepticSeizureTypeFOAutomatisms=models.IntegerField(choices=((1, "Checked"), (2,"Unchecked")))
    S05SEIZEpilepticSeizureTypeFOAtonic=models.IntegerField(choices=((1, "Checked"), (2,"Unchecked")))
    S05SEIZEpilepticSeizureTypeFOClonic=models.IntegerField(choices=((1, "Checked"), (2,"Unchecked")))
    S05SEIZEpilepticSeizureTypeFOLeft=models.IntegerField(choices=((1, "Checked"), (2,"Unchecked")))
    S05SEIZEpilepticSeizureTypeFORight=models.IntegerField(choices=((1, "Checked"), (2,"Unchecked")))
    S05SEIZEpilepticSeizureTypeFOEpilepticSpasms=models.IntegerField(choices=((1, "Checked"), (2,"Unchecked")))
    S05SEIZEpilepticSeizureTypeFOHyperkinetic=models.IntegerField(choices=((1, "Checked"), (2,"Unchecked")))
    S05SEIZEpilepticSeizureTypeFOMyoclonic=models.IntegerField(choices=((1, "Checked"), (2,"Unchecked")))
    S05SEIZEpilepticSeizureTypeFOTonic=models.IntegerField(choices=((1, "Checked"), (2,"Unchecked")))
    S05SEIZEpilepticSeizureTypeFOAutonomic=models.IntegerField(choices=((1, "Checked"), (2,"Unchecked")))
    S05SEIZEpilepticSeizureTypeFOBehaviourArrest=models.IntegerField(choices=((1, "Checked"), (2,"Unchecked")))
    S05SEIZEpilepticSeizureTypeFOCognitive=models.IntegerField(choices=((1, "Checked"), (2,"Unchecked")))
    S05SEIZEpilepticSeizureTypeFOEmotional=models.IntegerField(choices=((1, "Checked"), (2,"Unchecked")))
    S05SEIZEpilepticSeizureTypeFOSensory=models.IntegerField(choices=((1, "Checked"), (2,"Unchecked")))
    S05SEIZEpilepticSeizureTypeFOCentroTemporal=models.IntegerField(choices=((1, "Checked"), (2,"Unchecked")))
    S05SEIZEpilepticSeizureTypeFOTemporal=models.IntegerField(choices=((1, "Checked"), (2,"Unchecked")))
    S05SEIZEpilepticSeizureTypeFOFrontal=models.IntegerField(choices=((1, "Checked"), (2,"Unchecked")))
    S05SEIZEpilepticSeizureTypeFOParietal=models.IntegerField(choices=((1, "Checked"), (2,"Unchecked")))
    S05SEIZEpilepticSeizureTypeFOOccipital=models.IntegerField(choices=((1, "Checked"), (2,"Unchecked")))
    S05SEIZEpilepticSeizureTypeFOGelastic=models.IntegerField(choices=((1, "Checked"), (2,"Unchecked")))
    S05SEIZEpilepticSeizureTypeFOFocaltoBilateralTonicClonic=models.IntegerField(choices=((1, "Checked"), (2,"Unchecked")))
    S05SEIZEpilepticSeizureTypeFOOther=models.IntegerField(choices=((1, "Checked"), (2,"Unchecked")))
    S05SEIZEpilepticSeizureTypeFOOtherDetails=models.CharField(max_length=250)
    S05SEIZEpilepticSeizureTypeGeneralisedOnset=models.CharField(max_length=3, choices=(("TCl", "Tonic-clonic"), ("Clo", "Clonic"), ("Ton", "Tonic"), ("MyC", "Myoclonic"), ("MTC", "Myoclonic-tonic-clonic"), ("MAt", "Myoclonic-atonic"), ("Ato", "Atonic"), ("EpS", "Epileptic spasms"), ("TAb", "Typical absence"), ("Aab", "Atypical absence"), ("MAb", "Myoclonic absence"), ("AEM", "Absence with eyelid myoclonia"), ("Oth", "Other")))
    S05SEIZEpilepticSeizureTypeGeneralisedOnsetOtherDetails=models.CharField(max_length=250)
    S05SEIZNonEpilepticSeizureTypeUnknownOnset=models.CharField(max_length=3, choices=(("TCl", "Tonic-clonic"), ("EpS", "Epileptic spasms"), ("BAr", "Behaviour arrest"), ("Oth", "Other")))
    S05SEIZNonEpilepticSeizureTypeUnknownOnsetOtherDetails=models.CharField(max_length=250)
    S05SEIZNonEpilepticSeizureTypeSyncope=models.CharField(max_length=3,choices=(("a", "Vasovagal syncope"), ("b", "Reflex anoxic seizures"), ("c", "Breath-holding attacks"), ("d", "Hyperventilation syncope"), ("e", "Compulsive valsalva"), ("f", "Neurological syncope"), ("g", "Imposed upper airways obstruction"), ("h", "Orthostatic intolerance"), ("i", "Long QT and cardiac syncope"), ("j", "Hyper-cyanotic spells")))
    S05SEIZNonEpilepticSeizureTypeBehavioral=models.CharField(max_length=3, choices=(("a", "Daydreaming /inattention"), ("b", "Infantile gratification"), ("c", "Eidetic imagery"), ("d", "Tantrums and rage reactions"), ("e", "Out of body experiences"), ("f", "Panic attacks"), ("g", "Dissociative states"), ("h", "Non-epileptic seizures"), ("i", "Hallucinations in psychiatric disorders"), ("j", "Fabricated / factitious illness")))
    S05SEIZNonEpilepticSeizureTypeSleep=models.CharField(max_length=3,choices=(("a", "Sleep related rhythmic movement disorders"), ("b", "Hypnogogic jerks"), ("c", "Parasomnias"), ("d", "REM sleep disorders"), ("e", "Benign neonatal sleep myoclonus"), ("f", "Periodic leg movements"), ("g", "Narcolepsy-cataplexy")))
    S05SEIZNonEpilepticSeizureTypeParoxysmal=models.CharField(max_length=3,choices=(("a", "Tics"), ("b", "Stereotypies"), ("c", "Paroxysmal kinesigenic dyskinesia"), ("d", "Paroxysmal nonkinesigenic dyskinesia"), ("e", "Paroxysmal exercise induced dyskinesia"), ("f", "Benign paroxysmal tonic upgaze"), ("g", "Episodic ataxias"), ("h", "Alternating hemiplegia"), ("i", "Hyperekplexia"), ("j", "Opsoclonus-myoclonus syndrome")))
    S05SEIZNonEpilepticSeizureTypeMigraine=models.CharField(max_length=3,choices=(("a" ,"Migraine with visual aura"), ("b", "Familial hemiplegic migraine"), ("c", "Benign paroxysmal torticollis"), ("d", "Benign paroxysmal vertigo"), ("e", "Cyclical vomiting")))
    S05SEIZNonEpilepticSeizureTypeMiscellaneous=models.CharField(max_length=3,choices=(("a", "Benign myoclonus of infancy and shuddering attacks"), ("b", "Jitteriness"), ("c", "Sandifer syndrome"), ("d", "Non-epileptic head drops"), ("e", "Spasmus nutans"), ("f", "Raised intracranial pressure"), ("g", "Paroxysmal extreme pain disorder"), ("h", "Spinal myoclonus")))
...
class S06(models.Model):
    ...
    S06FirstEeg=models.IntegerField(2, choices=((1, "Not requested"), (2, "Requested and waiting"), (3, "Obtained"), (4, "Requested and did not attend"), (5, "Requested and attempted but not achieved")))
    S06FirstEegDate=models.DateField()
    S06FirstEegReasons=models.CharField(max_length=250)
    S0612LeadEcg=models.IntegerField(2, choices=((1, "Not requested"), (2, "Requested and waiting"), (3, "Obtained"), (4, "Requested and did not attend"), (5, "Requested and attempted but not achieved")))
    S0612LeadEcgDate=models.DateField()
    S0612LeadEcgReasons=models.CharField(max_length=250)
    S06IsThereEvidenceThatTheQtcCalculated=models.CharField(max_length=2, choices=(("Y","Yes"),("N", "No")))
    S06CtHeadScan=models.IntegerField(2, choices=((1, "Not requested"), (2, "Requested and waiting"), (3, "Obtained"), (4, "Requested and did not attend"), (5, "Requested and attempted but not achieved")))
    S06CtHeadScanDate=models.DateField()
    S06CtHeadScanReasons=models.CharField(max_length=250)
    S06MriBrain=models.IntegerField(2, choices=((1, "Not requested"), (2, "Requested and waiting"), (3, "Obtained"), (4, "Requested and did not attend"), (5, "Requested and attempted but not achieved")))
    ...
    S06FormChecked=models.IntegerField(choices=((1, "Checked"), (2,"Unchecked")))

class S07(models.Model):
    
    S07SectionStatus=models.CharField(max_length=2, choices=SECTION_STATUS_CHOICES)
    S07HasAnAedBeenGiven=models.CharField(max_length=2, choices=(("Y","Yes"),("N", "No")))
    S07AED=models.IntegerField(default=0)
    S07RescueMedication=models.CharField(max_length=2, choices=(("Y","Yes"),("N", "No")))
    S07RMED=models.IntegerField()
    S07DoesTheChildHaveAnyOfTheCESSReferralCriteria=models.CharField(max_length=2, choices=(("Y","Yes"),("N", "No")))
    S07DoesTheChildHaveAnyOfTheCESSReferralCriteriaNotes=models.CharField(max_length=250)
    S07FormChecked=models.IntegerField(choices=((1, "Checked"), (2,"Unchecked")))
...
class S08(models.Model):
    ...
    S08IndividualisedPlanningOfCare=models.CharField(max_length=2, choices=(("Y","Yes"),("N", "No")))
    S08IndividualisedPlanningOfCareDetails=models.CharField(max_length=250)
    S08IndividualisedEpilepsyDocuments=models.CharField(max_length=2, choices=(("Y","Yes"),("N", "No")))
    S08IndividualisedEpilepsyDocumentsDetails=models.CharField(max_length=250)
    S08ParentCarerPatientAgreementToThePlanOfCare=models.CharField(max_length=2, choices=(("Y","Yes"),("N", "No")))
    S08ParentCarerPatientAgreementToThePlanOfCareDetails=models.CharField(max_length=250)
    S08CarePlanUpdatedEvidence=models.CharField(max_length=2, choices=(("Y","Yes"),("N", "No")))
    S08CarePlanUpdatedEvidenceDetails=models.CharField(max_length=250)
    S08CareThatEncompassesServiceContact=models.CharField(max_length=2, choices=(("Y","Yes"),("N", "No")))
    S08Serv=models.IntegerField()
    S08CareThatEncompassesFirstAid=models.CharField(max_length=2, choices=(("Y","Yes"),("N", "No")))
    S08FAID=models.IntegerField()
    S08CareThatEncompassesAParentalProlongedSeizureCarePlan=models.CharField(max_length=2, choices=(("Y","Yes"),("N", "No")))
    S08PSCP=models.IntegerField()
    S08CareThatEncompassesGeneralParticipationAndRisk=models.CharField(max_length=2, choices=(("Y","Yes"),("N", "No")))
    S08Risk=models.IntegerField()
    S08CareThatEncompassesWaterSafety=models.CharField(max_length=2, choices=(("Y","Yes"),("N", "No")))
    S08Watr=models.IntegerField()
    S08CareThatEncompassesSUDEP=models.CharField(max_length=2, choices=(("Y","Yes"),("N", "No")))
    S08SUDP=models.IntegerField()
    S08CareThatEncompassesRoadSafety=models.CharField(max_length=2, choices=(("Y","Yes"),("N", "No")))
    S08RdSf=models.IntegerField()
    S08CareThatEncompassesHeights=models.CharField(max_length=2, choices=(("Y","Yes"),("N", "No")))
    S08Hght=models.IntegerField()
    S08CareThatEncompassesSleep=models.CharField(max_length=2, choices=(("Y","Yes"),("N", "No")))
    S08Slep=models.IntegerField()
    S08CareThatEncompassesPhotosensitivity=models.CharField(max_length=2, choices=(("Y","Yes"),("N", "No")))
    S08PtSe=models.IntegerField()
    S08Info=models.IntegerField()
    S08Teen=models.IntegerField()
    S08Epil=models.IntegerField()
    S08SeizureDiary=models.CharField(max_length=2, choices=(("Y","Yes"),("N", "No")))
    S08SzDi=models.IntegerField()
    S08IsThereEvidenceOfAIHP=models.IntegerField(choices=((1, "No evidence"), (2, "Requested but no other evidence"), (3, "Possibly in place but uncertain"), (4, "Documented as in place but no copy of IHP"), (5, "Copy of the IHP within trust health record")))
    S08IsThereEvidenceOfAIHPDate=models.DateField()
    S08IsThereEvidenceOfAnEHCP=models.IntegerField(choices=((1, "No evidence"), (2, "Requested but no other evidence"), (3, "Possibly in place but uncertain"), (4, "Documented as in place but no copy of EHCP"), (5, "Copy of the EHCP within trust health record"), ("NA", "Not applicable to this patient")))
    S08IsThereEvidenceOfAnEHCPDate=models.DateField()
    S08Edu=models.IntegerField()
    S08SiteCode=models.CharField(max_length=10)
    S08FormChecked=models.IntegerField(choices=((1, "Checked"), (2,"Unchecked")))
    ...
    S08EDUType=models.IntegerField(choices=((1, "Consent to share health information with school"), (2, "Teacher generic epilepsy awareness"), (3, "IEP (individual education plan)"), (4, "Exam Provision"), (5, "School rescue medication plan"), (6, "School rescue medication training"), (999, "Other")))
    ...
    S08EPILType=models.IntegerField(choices=((1, "Seizure diary"), (2, "Seizure types"), (3, "Syndrome type"), (4, "Prognosis"), (5, "Co-morbidities"), (6, "National Support Groups"), (999, "Other")))
    ...
    S08INFOType=models.CharField(max_length=3,choices=((1, "Treatment goals"), (2, "Drug information leaflet"), (3, "Sodium Valproate Risks and benefits"), (4, "VNS option"), (5, "Surgery option"), (6, "Ketogenic option"), (999, "Other")))
    ...
    S08TEENType=models.IntegerField(choices=((1, "Driving"), (2, "Contraception"), (3, "Pregnancy"), (4, "Adherence"), (5, "Sleep hygiene"), (6, "Alcohol"), (7, "Recreational Drugs"), (8, "Career"), (9, "Bus pass"), (10, "Seen on own"), (11, "Self management"), (12, "Goal setting"), (13, "Ready"), (14, "Steady"), (15, "Go"), (16, "Hello"), (999, "Other")))
...
class S09(models.Model):
    ...
    S09WhenWasTheLastEpilepticSeizureApxExcNK=models.CharField(max_length=3, choices=(("Apx", "Approximate date"), ("Exc", "Exact date"), ("NK", "Not known")))
    S09WhenWasTheLastEpilepticSeizure=models.DateField()
    S09WhenWasTheLastEpilepticSeizureUpdated=models.DateField()
    S09FormChecked=models.IntegerField(choices=((1, "Checked"), (2,"Unchecked")))

class S10(models.Model):
    
    S10SectionStatus=models.CharField(max_length=2, choices=SECTION_STATUS_CHOICES)
    S10ConsultantPaediatrician=models.IntegerField(choices=((1, "Input not requested"), (2, "Input requested and waiting for input"), (3, "Input requested and input achieved"), (4, "Input requested and rejected"), (5, "Input requested and non-attended")))
    ...
    S10Esn=models.IntegerField(choices=((1, "Input not requested"), (2, "Input requested and waiting for input"), (3, "Input requested and input achieved"), (4, "Input requested and rejected"), (5, "Input requested and non-attended")))
    S10EsnInputDate=models.DateField()
    S10EsnInputAchieved=models.DateField()
    S10EsnInputReasons=models.CharField(max_length=250)
    S10PaediatricNeurologist=models.IntegerField(choices=((1, "Input not requested"), (2, "Input requested and waiting for input"), (3, "Input requested and input achieved"), (4, "Input requested and rejected"), (5, "Input requested and non-attended")))
    ...
    S10Cess=models.IntegerField(choices=((1, "Input not requested"), (2, "Input requested and waiting for input"), (3, "Input requested and input achieved"), (4, "Input requested and rejected"), (5, "Input requested and non-attended")))
    ...
    S10KetognicDietician=models.IntegerField(choices=((1, "Input not requested"), (2, "Input requested and waiting for input"), (3, "Input requested and input achieved"), (4, "Input requested and rejected"), (5, "Input requested and non-attended")))
    ...
    S10VnsService=models.IntegerField(choices=((1, "Input not requested"), (2, "Input requested and waiting for input"), (3, "Input requested and input achieved"), (4, "Input requested and rejected"), (5, "Input requested and non-attended")))
    ...
    S10GeneticService=models.IntegerField(choices=((1, "Input not requested"), (2, "Input requested and waiting for input"), (3, "Input requested and input achieved"), (4, "Input requested and rejected"), (5, "Input requested and non-attended")))
    ...
    S10ClinicalPsychologist=models.IntegerField(choices=((1, "Input not requested"), (2, "Input requested and waiting for input"), (3, "Input requested and input achieved"), (4, "Input requested and rejected"), (5, "Input requested and non-attended")))
    ...
    S10EducationalPsychologist=models.IntegerField(choices=((1, "Input not requested"), (2, "Input requested and waiting for input"), (3, "Input requested and input achieved"), (4, "Input requested and rejected"), (5, "Input requested and non-attended")))
    ...
    S10Psychiatrist=models.IntegerField(choices=((1, "Input not requested"), (2, "Input requested and waiting for input"), (3, "Input requested and input achieved"), (4, "Input requested and rejected"), (5, "Input requested and non-attended")))
    ...
    S10Neuropyschologist=models.IntegerField(choices=((1, "Input not requested"), (2, "Input requested and waiting for input"), (3, "Input requested and input achieved"), (4, "Input requested and rejected"), (5, "Input requested and non-attended")))
    ...
    S10CounsellingService=models.IntegerField(choices=((1, "Input not requested"), (2, "Input requested and waiting for input"), (3, "Input requested and input achieved"), (4, "Input requested and rejected"), (5, "Input requested and non-attended")))
    ...
    S10OtherMentalHealthProfessional=models.IntegerField(choices=((1, "Input not requested"), (2, "Input requested and waiting for input"), (3, "Input requested and input achieved"), (4, "Input requested and rejected"), (5, "Input requested and non-attended")))
    ...
    S10YouthWorker=models.IntegerField(choices=((1, "Input not requested"), (2, "Input requested and waiting for input"), (3, "Input requested and input achieved"), (4, "Input requested and rejected"), (5, "Input requested and non-attended")))
    ...
    S10OtherFreeField=models.IntegerField(choices=((1, "Input not requested"), (2, "Input requested and waiting for input"), (3, "Input requested and input achieved"), (4, "Input requested and rejected"), (5, "Input requested and non-attended")))
    ...
    S10FormalDevelopmentalAssessment=models.CharField(max_length=2, choices=(("Y","Yes"),("N", "No")))
    S10FDA=models.IntegerField()
    S10FormalCognitiveAssessment=models.CharField(max_length=2, choices=(("Y","Yes"),("N", "No")))
    S10FCA=models.IntegerField()
    S10ReviewByAPaediatrician12Months=models.CharField(max_length=2, choices=(("Y","Yes"),("N", "No")))
    S10RBAP=models.IntegerField()
    S10DiagnosisOfEpilepsyWithdrawn=models.CharField(max_length=2, choices=(("Y","Yes"),("N", "No")))
    S10DOEW=models.IntegerField()
    S10FormChecked=models.IntegerField(choices=((1, "Checked"), (2,"Unchecked")))
...
#     "SEIZEpilepticSeizureTypeFOAutomatisms",models.IntegerField(choices=((1, "Checked"), (2,"Unchecked")))
...
#     "SEIZEpilepticSeizureTypeFOHyperkinetic",models.IntegerField(choices=((1, "Checked"), (2,"Unchecked")))
#     "SEIZEpilepticSeizureTypeFOMyoclonic",models.IntegerField(choices=((1, "Checked"), (2,"Unchecked")))
...
#     "SEIZEpilepticSeizureTypeFOCognitive",models.IntegerField(choices=((1, "Checked"), (2,"Unchecked")))
#     "SEIZEpilepticSeizureTypeFOEmotional",models.IntegerField(choices=((1, "Checked"), (2,"Unchecked")))
