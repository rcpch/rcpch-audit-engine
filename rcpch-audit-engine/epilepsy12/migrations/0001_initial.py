# Generated by Django 4.0 on 2022-02-19 19:12
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('antiepilepsy_medicine_type_other', models.CharField(max_length=50, verbose_name='other antiepilepsy medicine name')),
                ('antiepilepsy_medicine_snomed_code', models.CharField(max_length=50, verbose_name='antiepilepsy medicine SNOMED-CT code')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('assessment_date', models.DateTimeField(verbose_name='Date of assessment')),
                ('rescue_medication_prescribed', models.BooleanField(default=False, verbose_name='Has a rescue medicine been prescribed?')),
                ('does_the_child_have_any_of_the_childrens_epilepsy_surgical_service_referral_criteria', models.BooleanField(default=False, verbose_name="Have the criteria for referral to a children's epilepsy surgery service been met?")),
                ...
                ('prolonged_generalized_convulsive_seizures', models.CharField(choices=[('Y', 'Yes'), ('N', 'No'), ('U', 'Uncertain')], max_length=3, verbose_name='Were there any prolonged generalised epileptic seizures?')),
                ('experienced_prolonged_focal_seizures', models.CharField(choices=[('Y', 'Yes'), ('N', 'No'), ('U', 'Uncertain')], max_length=3, verbose_name='Were there any prolonged focal seizures?')),
                ('has_an_aed_been_given', models.CharField(choices=[('Y', 'Yes'), ('N', 'No')], max_length=2, verbose_name='Has an antiepilepsy medicine been given?')),
                ('paroxysmal_episode', models.CharField(choices=[('Y', 'Yes'), ('N', 'No')], max_length=1, verbose_name='Were any episodes paroxysmal?')),
                ('antiepilepsy_medicines', models.ManyToManyField(to='epilepsy12.AntiEpilepsyMedicine', verbose_name='list of antiepilepsy medicines')),
                ('created_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='created%(app_label)s_%(class)s_related', to='auth.user', verbose_name='record created by user in %(class)')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('previous_febrile_seizure', models.CharField(choices=[('Y', 'Yes'), ('N', 'No'), ('U', 'Uncertain')], max_length=2, verbose_name='has there been a previous febrile seizure?')),
                ('previous_acute_symptomatic_seizure', models.CharField(choices=[('Y', 'Yes'), ('N', 'No'), ('U', 'Uncertain')], max_length=2, verbose_name='has there been a previous acute symptomatic seizure?')),
                ('is_there_a_family_history_of_epilepsy', models.CharField(choices=[('Y', 'Yes'), ('N', 'No'), ('U', 'Uncertain')], max_length=3, verbose_name='is there a family history of epilepsy?')),
                ('previous_neonatal_seizures', models.CharField(choices=[('Y', 'Yes'), ('N', 'No'), ('U', 'Uncertain')], max_length=2, verbose_name='were there seizures in the neonatal period?')),
                ('diagnosis_of_epilepsy_withdrawn', models.CharField(choices=[('Y', 'Yes'), ('N', 'No')], max_length=2, verbose_name='has the diagnosis of epilepsy been withdrawn?')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('hospital_trust_name', models.CharField(max_length=100, verbose_name='hospital trust full name')),
                ('created_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='created%(app_label)s_%(class)s_related', to='auth.user', verbose_name='record created by user in %(class)')),
                ('updated_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='updated%(app_label)s_%(class)s_related', to='auth.user', verbose_name='record updated by user in %(class)')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('case', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='epilepsy12.case')),
                ('created_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='created%(app_label)s_%(class)s_related', to='auth.user', verbose_name='record created by user in %(class)')),
                ('hospital_trust', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='hospital_trust', related_query_name='hospitals', to='epilepsy12.hospitaltrust')),
                ('updated_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='updated%(app_label)s_%(class)s_related', to='auth.user', verbose_name='record updated by user in %(class)')),
            ],
            options={
                'verbose_name': 'site',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('non_epileptic_seizure_type', models.CharField(choices=[('SAS', 'Syncope And Anoxic Seizures'), ('BPP', 'Behavioral Psychological And Psychiatric Disorders'), ('SRC', 'Sleep Related Conditions'), ('PMD', 'Paroxysmal Movement Disorders'), ('MAD', 'Migraine Associated Disorders'), ('ME', 'Miscellaneous Events'), ('Oth', 'Other')], max_length=3)),
                ('focal_onset_impaired_awareness', models.IntegerField(choices=[(1, 'Checked'), (2, 'Unchecked')])),
                ('focal_onset_automatisms', models.IntegerField(choices=[(1, 'Checked'), (2, 'Unchecked')])),
                ('focal_onset_atonic', models.IntegerField(choices=[(1, 'Checked'), (2, 'Unchecked')])),
                ('focal_onset_clonic', models.IntegerField(choices=[(1, 'Checked'), (2, 'Unchecked')])),
                ('focal_onset_left', models.IntegerField(choices=[(1, 'Checked'), (2, 'Unchecked')])),
                ('focal_onset_right', models.IntegerField(choices=[(1, 'Checked'), (2, 'Unchecked')])),
                ('focal_onset_epileptic_spasms', models.IntegerField(choices=[(1, 'Checked'), (2, 'Unchecked')])),
                ('focal_onset_hyperkinetic', models.IntegerField(choices=[(1, 'Checked'), (2, 'Unchecked')])),
                ('focal_onset_myoclonic', models.IntegerField(choices=[(1, 'Checked'), (2, 'Unchecked')])),
                ('focal_onset_tonic', models.IntegerField(choices=[(1, 'Checked'), (2, 'Unchecked')])),
                ('focal_onset_autonomic', models.IntegerField(choices=[(1, 'Checked'), (2, 'Unchecked')])),
                ('focal_onset_behavioural_arrest', models.IntegerField(choices=[(1, 'Checked'), (2, 'Unchecked')])),
                ('focal_onset_cognitive', models.IntegerField(choices=[(1, 'Checked'), (2, 'Unchecked')])),
                ('focal_onset_emotional', models.IntegerField(choices=[(1, 'Checked'), (2, 'Unchecked')])),
                ('focal_onset_sensory', models.IntegerField(choices=[(1, 'Checked'), (2, 'Unchecked')])),
                ('focal_onset_centrotemporal', models.IntegerField(choices=[(1, 'Checked'), (2, 'Unchecked')])),
                ('focal_onset_temporal', models.IntegerField(choices=[(1, 'Checked'), (2, 'Unchecked')])),
                ('focal_onset_frontal', models.IntegerField(choices=[(1, 'Checked'), (2, 'Unchecked')])),
                ('focal_onset_parietal', models.IntegerField(choices=[(1, 'Checked'), (2, 'Unchecked')])),
                ('focal_onset_occipital', models.IntegerField(choices=[(1, 'Checked'), (2, 'Unchecked')])),
                ('focal_onset_gelastic', models.IntegerField(choices=[(1, 'Checked'), (2, 'Unchecked')])),
                ('focal_onset_focal_to_bilateral_tonic_clonic', models.IntegerField(choices=[(1, 'Checked'), (2, 'Unchecked')])),
                ('focal_onset_other', models.IntegerField(choices=[(1, 'Checked'), (2, 'Unchecked')])),
                ('focal_onset_other_details', models.CharField(max_length=250)),
                ('generalised_onset', models.CharField(choices=[('TCl', 'Tonic-clonic'), ('Clo', 'Clonic'), ('Ton', 'Tonic'), ('MyC', 'Myoclonic'), ('MTC', 'Myoclonic-tonic-clonic'), ('MAt', 'Myoclonic-atonic'), ('Ato', 'Atonic'), ('EpS', 'Epileptic spasms'), ('TAb', 'Typical absence'), ('Aab', 'Atypical absence'), ('MAb', 'Myoclonic absence'), ('AEM', 'Absence with eyelid myoclonia'), ('Oth', 'Other')], max_length=3)),
                ('generalised_onset_other_details', models.CharField(max_length=250)),
                ('nonepileptic_seizure_unknown_onset', models.CharField(choices=[('TCl', 'Tonic-clonic'), ('EpS', 'Epileptic spasms'), ('BAr', 'Behaviour arrest'), ('Oth', 'Other')], max_length=3)),
                ('nonepileptic_seizure_unknown_onset_other_details', models.CharField(max_length=250)),
                ('nonepileptic_seizure_syncope', models.CharField(choices=[('a', 'Vasovagal syncope'), ('b', 'Reflex anoxic seizures'), ('c', 'Breath-holding attacks'), ('d', 'Hyperventilation syncope'), ('e', 'Compulsive valsalva'), ('f', 'Neurological syncope'), ('g', 'Imposed upper airways obstruction'), ('h', 'Orthostatic intolerance'), ('i', 'Long QT and cardiac syncope'), ('j', 'Hyper-cyanotic spells')], max_length=3)),
                ('nonepileptic_seizure_behavioural', models.CharField(choices=[('a', 'Daydreaming /inattention'), ('b', 'Infantile gratification'), ('c', 'Eidetic imagery'), ('d', 'Tantrums and rage reactions'), ('e', 'Out of body experiences'), ('f', 'Panic attacks'), ('g', 'Dissociative states'), ('h', 'Non-epileptic seizures'), ('i', 'Hallucinations in psychiatric disorders'), ('j', 'Fabricated / factitious illness')], max_length=3)),
                ('nonepileptic_seizure_sleep', models.CharField(choices=[('a', 'Sleep related rhythmic movement disorders'), ('b', 'Hypnogogic jerks'), ('c', 'Parasomnias'), ('d', 'REM sleep disorders'), ('e', 'Benign neonatal sleep myoclonus'), ('f', 'Periodic leg movements'), ('g', 'Narcolepsy-cataplexy')], max_length=3)),
                ('nonepileptic_seizure_paroxysmal', models.CharField(choices=[('a', 'Tics'), ('b', 'Stereotypies'), ('c', 'Paroxysmal kinesigenic dyskinesia'), ('d', 'Paroxysmal nonkinesigenic dyskinesia'), ('e', 'Paroxysmal exercise induced dyskinesia'), ('f', 'Benign paroxysmal tonic upgaze'), ('g', 'Episodic ataxias'), ('h', 'Alternating hemiplegia'), ('i', 'Hyperekplexia'), ('j', 'Opsoclonus-myoclonus syndrome')], max_length=3)),
                ('nonepileptic_seizure_migraine', models.CharField(choices=[('a', 'Migraine with visual aura'), ('b', 'Familial hemiplegic migraine'), ('c', 'Benign paroxysmal torticollis'), ('d', 'Benign paroxysmal vertigo'), ('e', 'Cyclical vomiting')], max_length=3)),
                ('nonepileptic_seizure_miscellaneous', models.CharField(choices=[('a', 'Benign myoclonus of infancy and shuddering attacks'), ('b', 'Jitteriness'), ('c', 'Sandifer syndrome'), ('d', 'Non-epileptic head drops'), ('e', 'Spasmus nutans'), ('f', 'Raised intracranial pressure'), ('g', 'Paroxysmal extreme pain disorder'), ('h', 'Spinal myoclonus')], max_length=3)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('seizure_cause_main_snomed_code', models.CharField(choices=[('Str', 'Structural'), ('Gen', 'Genetic'), ('Inf', 'Infectious'), ('Met', 'Metabolic'), ('Imm', 'Immune'), ('NK', 'Not known')], max_length=3, verbose_name='SNOMED-CT code for main identified cause of seizure(s)')),
                ('seizure_cause_structural', models.CharField(choices=[('TbS', 'Tuberous Sclerosis'), ('StW', 'Sturge Weber'), ('FCD', 'Focal cortical dysplasia'), ('HyH', 'Hypothalamic Hamartoma'), ('LGT', 'Low grade tumour'), ('TuO', 'Tumour (other)'), ('MCD', 'Malformations of Cortical Development'), ('Vas', 'Vascular (eg arterial ischaemic stroke venous ischaemia cerebral haemorrhage)'), ('TBI', 'Traumatic brain injury'), ('NR', 'Not required')], max_length=3, verbose_name='main identified structural cause of seizure(s)')),
                ('seizure_cause_structural_snomed_code', models.CharField(choices=[('TbS', 'Tuberous Sclerosis'), ('StW', 'Sturge Weber'), ('FCD', 'Focal cortical dysplasia'), ('HyH', 'Hypothalamic Hamartoma'), ('LGT', 'Low grade tumour'), ('TuO', 'Tumour (other)'), ('MCD', 'Malformations of Cortical Development'), ('Vas', 'Vascular (eg arterial ischaemic stroke venous ischaemia cerebral haemorrhage)'), ('TBI', 'Traumatic brain injury'), ('NR', 'Not required')], max_length=3, verbose_name='SNOMED-CT code for main identified structural cause of seizure(s)')),
                ('seizure_cause_genetic', models.CharField(choices=[('DrS', 'Dravet syndrome'), ('GTD', 'Glucose Transporter Defect'), ('AnS', 'Angelman Syndrome'), ('ReS', 'Rett Syndrome'), ('ChA', 'Chromosomal abnormality'), ('GeA', 'Gene abnormality')], max_length=3, verbose_name='main identified genetic cause of seizure(s)')),
                ('seizure_cause_gene_abnormality', models.CharField(choices=[('UBE', 'UBE3A'), ('GLU', 'GLUT1'), ('SLC', 'SLC2A1'), ('MEC', 'MECP2'), ('SCN', 'SCN1A'), ('STX', 'STXBP1'), ('CDK', 'CDKL5'), ('KCN', 'KCNQ2'), ('SCN', 'SCN2A'), ('KCN', 'KCNT1'), ('ARX', 'ARX'), ('FOX', 'FOXG1'), ('PCD', 'PCDH19'), ('GRI', 'GRIN2A'), ('Oth', 'Other')], max_length=3, verbose_name='main identified gene abnormality cause of seizure(s)')),
                ('seizure_cause_genetic_other', models.CharField(max_length=250, verbose_name='other identified genetic cause of seizure(s) not previously specified.')),
                ('seizure_cause_gene_abnormality_snomed_code', models.CharField(max_length=50, verbose_name='SNOMED-CT code for main identified genetic cause of seizure(s)')),
                ('seizure_cause_chromosomal_abnormality', models.CharField(max_length=200, verbose_name='main identified chromosomal cause of seizure(s)')),
                ('seizure_cause_infectious', models.CharField(max_length=250, verbose_name='main identified infectious cause of seizure(s)')),
                ('seizure_cause_infectious_snomed_code', models.CharField(max_length=250, verbose_name='SNOMED-CT code for main identified infectious cause of seizure(s)')),
                ('seizure_cause_metabolic', models.CharField(choices=[('Mit', 'Mitochondrial disorder'), ('Neu', 'Neuronal Ceroid Lipofuscinosis (Batten Disease)'), ('PPM', 'Disorder of pyridoxine/pyridoxal phosphate metabolism'), ('BiM', 'Disorder of biotin metabolism'), ('CrM', 'Disorder of creatine metabolism'), ('AmA', 'Disorder of amino acid'), ('UrA', 'Disorder of urea cycle'), ('PyP', 'Disorder of pyrimidine and purine'), ('Cho', 'Disorder of cholesterol'), ('Oth', 'Other neurometabolic disorder')], max_length=3, verbose_name='main identified metabolic cause of seizure(s)')),
                ('seizure_cause_metabolic_other', models.CharField(max_length=250, verbose_name='other identified metabolic cause of seizure(s) not previously specified.')),
                ('seizure_cause_metabolic_snomed_code', models.CharField(max_length=250, verbose_name='SNOMED-CT code for other identified metabolic cause of seizure(s) not previously specified.')),
                ('seizure_cause_immune', models.CharField(choices=[('RaE', 'Rasmussen Encephalitis'), ('AnM', 'Antibody mediated')], max_length=3, verbose_name='main identified immune cause of seizure(s).')),
                ('seizure_cause_immune_antibody', models.CharField(choices=[('VGK', 'VGKC'), ('NMD', 'NMDAR'), ('GAD', 'GAD'), ('TPO', 'TPO'), ('MOG', 'MOG'), ('Oth', 'Other')], max_length=3, verbose_name='autoantibody identified as cause of seizure(s).')),
                ('seizure_cause_immune_antibody_other', models.CharField(max_length=250, verbose_name='other identified antibody not previously specified causing seizure(s).')),
                ('seizure_cause_immune_snomed_code', models.CharField(max_length=250, verbose_name='SNOMED-CT code for main identified immune cause of seizure(s).')),
                ('created_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='created%(app_label)s_%(class)s_related', to='auth.user', verbose_name='record created by user in %(class)')),
                ('updated_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='updated%(app_label)s_%(class)s_related', to='auth.user', verbose_name='record updated by user in %(class)')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('registration_uuid', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False, verbose_name='Unique identifier for each registration in the Epilepsy12 audit for a give year.')),
                ('registration_date', models.DateField(verbose_name='Date on which registered for the the Epilepsy12 audit')),
                ('locked', models.BooleanField(default=False, verbose_name='Case is locked from further data entry. This occurs automatically if a year has passed since the registration date.')),
                ('locked_at', models.DateTimeField(auto_now_add=True, verbose_name='The date and time at which the registration was locked from further data entry.')),
                ('closed', models.BooleanField(default=False, verbose_name='Case has been closed and will not participate in audit analysis.')),
                ('referring_clinician', models.CharField(max_length=50)),
                ('diagnostic_status', models.CharField(choices=[('a', 'The child has had an episode or episodes where one or more are considered epileptic'), ('b', 'The child has had an episode or episodes that are considered non-epileptic only'), ('c', 'The child has had an episode or episodes where there remains uncertainty whether episodes were epileptic or not.')], max_length=1, verbose_name='Status of epilepsy diagnosis. Must have epilepsy or probable epilepsy to be included.')),
                ('case', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='epilepsy12.case')),
                ('created_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='created%(app_label)s_%(class)s_related', to='auth.user', verbose_name='record created by user in %(class)')),
                ('locked_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='auth.user', verbose_name='The user who locked the registration from further data entry.')),
                ('referring_hospital', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='epilepsy12.hospitaltrust', verbose_name='Name of referring hospital')),
                ('site', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='epilepsy12.site')),
                ('updated_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='updated%(app_label)s_%(class)s_related', to='auth.user', verbose_name='record updated by user in %(class)')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('first_paediatric_assessment_in_acute_or_nonacute_setting', models.CharField(choices=[(1, 'Acute'), (2, 'Non-acute'), (3, "Don't know")], max_length=2, verbose_name='Is the first paediatric assessment in an acute or nonacute setting?')),
                ...
                ('has_frequency_or_number_of_episodes_since_the_first_episode_been_documented', models.BooleanField(default=False, verbose_name='has the frequency of episodes since the first recorded been documented?')),
                ...
                ('assessment', models.OneToOneField(on_delete=django.db.models.deletion.DO_NOTHING, to='epilepsy12.assessment', verbose_name='related assessment')),
                ('case', models.OneToOneField(on_delete=django.db.models.deletion.DO_NOTHING, to='epilepsy12.case', verbose_name='related case')),
                ('created_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='created%(app_label)s_%(class)s_related', to='auth.user', verbose_name='record created by user in %(class)')),
                ('epilepsy_context', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='epilepsy12.epilepsycontext', verbose_name='related epilepsy context')),
                ('updated_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='updated%(app_label)s_%(class)s_related', to='auth.user', verbose_name='record updated by user in %(class)')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='epilepsy12.electroclinicalsyndrome', verbose_name='related electroclinical syndrome'),
        ),
        migrations.AddField(
            model_name='assessment',
            name='investigations',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='epilepsy12.investigations', verbose_name='related investigations'),
        ),
        migrations.AddField(
            model_name='assessment',
            name='nonepilepsy',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='epilepsy12.nonepilepsy', verbose_name='related nonepilepsy explanation'),
        ),
        migrations.AddField(
            model_name='assessment',
            name='registration',
            field=models.OneToOneField(on_delete=django.db.models.deletion.DO_NOTHING, to='epilepsy12.registration', verbose_name='related registration'),
        ),
        migrations.AddField(
            model_name='assessment',
            name='rescue_medicines',
            field=models.ManyToManyField(to='epilepsy12.RescueMedicine', verbose_name='list of rescue medicines'),
        ),
        migrations.AddField(
            model_name='assessment',
            name='seizure_causes',
            field=models.ManyToManyField(to='epilepsy12.SeizureCause', verbose_name='list of seizure causes'),
        ),
        migrations.AddField(
            model_name='assessment',
            name='updated_by',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='updated%(app_label)s_%(class)s_related', to='auth.user', verbose_name='record updated by user in %(class)'),
        ),
        migrations.AddIndex(
