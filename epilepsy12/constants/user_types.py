...
CAN_EDIT_EPILEPSY_CONTEXT_FIELDS = ('can_edit_epilepsy_context_fields',
                                    'Can edit all fiedls related to epilepsy context.')
...
EPILEPSY12_AUDIT_TEAM_EDIT_ACCESS_PERMISSIONS = EPILEPSY12_AUDIT_TEAM_VIEW_ONLY_PERMISSIONS + [
    CAN_VIEW_CHILD_NHS_NUMBER,
    CAN_VIEW_CHILD_DATE_OF_BIRTH,
    CAN_UPDATE_CHILD_CASE_DATA,
    CAN_LOCK_CHILD_CASE_DATA_FROM_EDITING,
...
EPILEPSY12_AUDIT_TEAM_FULL_ACCESS_PERMISSIONS = EPILEPSY12_AUDIT_TEAM_EDIT_ACCESS_PERMISSIONS + [
    CAN_UNLOCK_CHILD_CASE_DATA_FROM_EDITING,
    CAN_OPT_OUT_CHILD_FROM_INCLUSION_IN_AUDIT,
    CAN_REMOVE_APPROVAL_OF_ELIGIBILITY,
    CAN_UNREGISTER_CHILD_IN_EPILEPSY12,
...
TRUST_AUDIT_TEAM_EDIT_ACCESS_PERMISSIONS = TRUST_AUDIT_TEAM_VIEW_ONLY_PERMISSIONS + [
    CAN_VIEW_CHILD_NHS_NUMBER,
    CAN_VIEW_CHILD_DATE_OF_BIRTH,
    CAN_UPDATE_CHILD_CASE_DATA,
    CAN_LOCK_CHILD_CASE_DATA_FROM_EDITING,
...
TRUST_AUDIT_TEAM_FULL_ACCESS_PERMISSIONS = TRUST_AUDIT_TEAM_EDIT_ACCESS_PERMISSIONS + [
    CAN_UNLOCK_CHILD_CASE_DATA_FROM_EDITING,
    CAN_OPT_OUT_CHILD_FROM_INCLUSION_IN_AUDIT,
    CAN_REMOVE_APPROVAL_OF_ELIGIBILITY,
    CAN_UNREGISTER_CHILD_IN_EPILEPSY12,
