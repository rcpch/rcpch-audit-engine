"""
Arrays and field names relating to focal seizures for radiobuttons
"""
...
FOCAL_EPILEPSY_MOTOR_MANIFESTATIONS = [
    ...
    {"name": "focal_onset_tonic", "text": "Tonic"},
    {
        ...
        "text": "Focal to Bilateral Tonic-Clonic",
    },
...
LATERALITY = [
    ...
    {"name": "focal_onset_laterality_unknown", "text": "Unknown"},
]
