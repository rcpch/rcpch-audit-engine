...
class KPI(models.Model, HelpTextMixin):
    ...
    """
    Percentage of children and young people with epilepsy, with input by a ‘consultant paediatrician with expertise in epilepsies’ within 2 weeks of initial referral
    ...
    """
    Percentage of children and young people with epilepsy, with input by epilepsy specialist nurse within the first year of care.
    ...
    epilepsy_specialist_nurse = models.IntegerField(
        help_text={
            'label': 'Epilepsy Specialist Nurse',
    ...
    """
    Percentage of children and young people meeting defined criteria for paediatric neurology referral, with input of tertiary care and/or CESS referral within the first year of care.
    ...
    """
    Percentage of ongoing children and young people meeting defined epilepsy surgery referral criteria with evidence of epilepsy surgery referral.
    ...
    epilepsy_surgery_referral = models.IntegerField(
        help_text={
            'label': 'Epilepsy surgery referral',
    ...
    """
    Percentage of children and young people with convulsive seizures and epilepsy, with an ECG at first year.
    ...
    """
    Percentage of children and young people with defined indications for an MRI, who had who had timely MRI within 6 weeks of request
    ...
    """
    Percentage of children with epilepsy where there is documented evidence that they have been asked about mental health either through clinical screening, or a questionnaire/measure.
    ...
    assessment_of_mental_health_issues = models.IntegerField(
        help_text={
            'label': 'Assessment of mental health issues',
    ...
    """
    Percentage of children and young people with epilepsy after 12 months where there is evidence of a comprehensive care plan that is agreed between the person, their family and/or carers and primary and secondary care providers, and the care plan has been updated where necessary.
    ...
    comprehensive_care_planning_agreement = models.IntegerField(
        help_text={
            'label': 'Comprehensive care planning agreement',
    ...
    """
    Percentage of children and young people with epilepsy after 12 months that had an individualised epilepsy document with individualised epilepsy document or a copy clinic letter that includes care planning information.
    ...
    patient_held_individualised_epilepsy_document = models.IntegerField(
        ...
        help_text={
            'label': 'Patient-held individualised epilepsy document/copy of clinic letter that includes care planning information',
    ...
    """
    Percentage of children and young people with epilepsy after 12 months where there was evidence of agreement between the person, their family and/or carers as appropriate.
    ...
    patient_carer_parent_agreement_to_the_care_planning = models.IntegerField(
        help_text={
            'label': 'Patient/carer/parent agreement to the care planning',
    ...
    """
    Percentage of children and young people with epilepsy after 12 months where there is evidence that the care plan has been updated where necessary.
    ...
    care_planning_has_been_updated_when_necessary = models.IntegerField(
        help_text={
            'label': 'Care planning has been updated when necessary',
    ...
    comprehensive_care_planning_content = models.IntegerField(
        help_text={
            'label': 'Comprehensive care planning content',
    ...
    parental_prolonged_seizures_care_plan = models.IntegerField(
        help_text={
            'label': 'Parental prolonged seizures care plan',
            'reference': ""
        },
        default=0,
        null=True
    ...
    general_participation_and_risk = models.IntegerField(
        help_text={
            'label': 'General participation and risk',
            'reference': ""
        },
        default=0,
        null=True
    ...
    sudep = models.IntegerField(
        help_text={
            'label': 'Sudden unexplained death in epilepsy',
            'reference': ""
        },
        default=0,
        null=True
    ...
    school_individual_healthcare_plan = models.IntegerField(
        help_text={
            'label': 'School individualised health care plan',
            'reference': ""
        },
        default=0,
        null=True
...
"""
The 12 key performance indicators are
...
5. MRI	
    % of children and young people with defined indications for an MRI, who had who had timely MRI within 6 weeks of request
6. Assessment of mental health issues 
    %  of children with epilepsy where there is documented evidence that they have been asked about mental health either through clinical screening, or a questionnaire/measure
7. Mental health support
    %  of children with epilepsy and a mental health problem who have evidence of mental health support"
8. Sodium Valproate
    % of all females 12 years and above currently on valproate treatment with annual risk acknowledgement form completed
9. Comprehensive Care Planning agreement 
...
9a Patient held individualised epilepsy document/copy of clinic letter that includes care planning information
...
9b Patient/carer/parent agreement to the care planning
...
9c Care planning has been updated when necessary
    % of children and young people with epilepsy after 12 months where there is evidence that the care plan has been updated where necessary
9d Comprehensive Care Planning content
    % of children diagnosed with epilepsy with documented evidence of communication regarding core elements of care planning
9e Parental prolonged seizures care plan
9f. Water safety
9g. First aid
9h. General participation and risk
9i. Service contact details
9j. SUDEP
10. School Individual Healthcare Plan
    % of children and young people with epilepsy aged 5 years and above with evidence of a school individual healthcare plan by 1 year after first paediatric assessment.
