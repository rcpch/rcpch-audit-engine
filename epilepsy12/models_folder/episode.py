...
class Episode(TimeStampAbstractBaseClass, UserStampAbstractBaseClass, HelpTextMixin):
    ...
    description_keywords = ArrayField(
        models.CharField(help_text="add a key word", max_length=500),
        blank=True,
        null=True,
    )
    ...
    focal_onset_automatisms = models.BooleanField(default=None, blank=True, null=True)
    focal_onset_atonic = models.BooleanField(default=None, blank=True, null=True)
    ...
    focal_onset_hyperkinetic = models.BooleanField(default=None, blank=True, null=True)
    focal_onset_myoclonic = models.BooleanField(default=None, blank=True, null=True)
    focal_onset_tonic = models.BooleanField(default=None, blank=True, null=True)
    focal_onset_autonomic = models.BooleanField(default=None, blank=True, null=True)
    focal_onset_behavioural_arrest = models.BooleanField(
        default=None, blank=True, null=True
    )
    focal_onset_cognitive = models.BooleanField(default=None, blank=True, null=True)
    focal_onset_emotional = models.BooleanField(default=None, blank=True, null=True)
    focal_onset_sensory = models.BooleanField(default=None, blank=True, null=True)
    focal_onset_centrotemporal = models.BooleanField(
        default=None, blank=True, null=True
    )
    focal_onset_temporal = models.BooleanField(default=None, blank=True, null=True)
    focal_onset_frontal = models.BooleanField(default=None, blank=True, null=True)
    focal_onset_parietal = models.BooleanField(default=None, blank=True, null=True)
    focal_onset_occipital = models.BooleanField(default=None, blank=True, null=True)
    focal_onset_gelastic = models.BooleanField(default=None, blank=True, null=True)
