...
from django.contrib.gis.db.models import PointField, CharField, FloatField, DateTimeField
# 3rd party
...
class Organisation(models.Model):
    ...
    Geocode_Coordinates = PointField(
        null=True,
        blank=True,
        default=None
    )
