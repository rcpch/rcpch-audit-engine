...
#   DEPRECATED - this function is no longer used as the comorbidity list is now stored as a json file in the constants folder. This is because the comorbidity list is not expected to change frequently and this approach reduces the number of calls to the RPCH Hermes API.
#     """
...
#     DEPRECATED - Epilepsy causes are nolonger tracked
#     """
