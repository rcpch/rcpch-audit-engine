...
def test_cases_aggregated_by_ethnicity(e12_case_factory):
    ...
    expected_counts = [
        ...
        {"ethnicity_display": "Asian or Asian British - Any other Asian background", "ethnicities": 10},
        {"ethnicity_display": "Black or Black British - Any other Black background", "ethnicities": 10},
        {"ethnicity_display": "Other Ethnic Groups - Any other ethnic group", "ethnicities": 10},
        ...
        {"ethnicity_display": "Asian or Asian British - Bangladeshi", "ethnicities": 10},
