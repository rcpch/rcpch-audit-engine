...
[] Assert an RCPCH Audit Lead can let a child opt out of Epilepsy12
...
[] Assert an RCPCH Audit Lead can lock a child from being edited
[] Assert an RCPCH Audit Lead can unlock a child from being edited
...
[] Assert an RCPCH Audit Lead CANNOT consent for a child to be included in Epilepsy12
