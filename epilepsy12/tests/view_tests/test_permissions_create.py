...
[ ] Assert RCPCH Audit Team can create users nationally, within any organisations  - response.status_code == 200
...
[ ] Assert RCPCH Audit Team can create patients nationally, within any organisations - response.status_code == 200
...
[ ] Assert RCPCH Audit Team can create patient records nationally, within any organisations - response.status_code == 200
...
[ ] Assert RCPCH Audit Team can can 'add_episode' inside any Trust - response.status_code == 200
...
[ ] Assert RCPCH Audit Team can can 'add_comorbidity' inside any Trust - response.status_code == 200
...
[ ] Assert RCPCH Audit Team can can 'add_syndrome' inside any Trust - response.status_code == 200
...
[ ] Assert RCPCH Audit Team can can 'add_antiepilepsy_medicine' inside any Trust - response.status_code == 200
"""
