...
class E12AntiEpilepsyMedicineFactory(factory.django.DjangoModelFactory):
    ...
    Default:
        - medicine_entity = Sodium Valproate
            - IF female, childbearing age -> all pregnancy-related fields are True
        - is_rescue = False
    Flags:
        - `rescue`: if True, changes medicine_entity to Lorazepam and is_rescue to True
    """
