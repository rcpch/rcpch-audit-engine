...
router.register(r"first_paediatric_assessments", views.FirstPaediatricAssessmentViewSet)
...
urlpatterns = [
    ...
    path(
        ...
        views.case_performance_summary,
    ...
    path("uk_shapes", views.uk_shapes, name="uk_shapes"),
]
...
htmx_paths = [
    ...
    path("episode/<int:episode_id>/edit", views.edit_episode, name="edit_episode"),
    path(
        "episode/<int:episode_id>/delete", views.remove_episode, name="remove_episode"
    ),
    path("episode/<int:episode_id>/close", views.close_episode, name="close_episode"),
    path(
    ...
    path(
        ...
        views.update_paediatric_neurology_centre_pressed,
    ...
    path(
        ...
        views.childrens_epilepsy_surgical_service_referral_criteria_met,
    ...
    path(
        ...
        views.childrens_epilepsy_surgical_service_referral_made,
    ...
    path(
        ...
        views.childrens_epilepsy_surgical_service_referral_date,
    ...
    path(
        ...
        views.childrens_epilepsy_surgical_service_input_date,
    ...
    path(
        ...
        views.experienced_prolonged_generalized_convulsive_seizures,
    ...
    path(
        ...
        views.mri_brain_requested_date,
    ...
    path(
        ...
        views.antiepilepsy_medicine_start_date,
    ...
    path(
        ...
        views.antiepilepsy_medicine_risk_discussed,
    ...
    path(
        ...
        views.is_a_pregnancy_prevention_programme_in_place,
    ...
    path(
        ...
        views.has_a_valproate_annual_risk_acknowledgement_form_been_completed,
    ...
    path(
        ...
        views.individualised_care_plan_includes_service_contact_details,
    ...
    path(
        ...
        views.individualised_care_plan_include_first_aid,
    ...
    path(
        ...
        views.individualised_care_plan_parental_prolonged_seizure_care,
    ...
    path(
        ...
        views.individualised_care_plan_addresses_water_safety,
    ...
    path(
        ...
        views.has_individualised_care_plan_been_updated_in_the_last_year,
