...
urlpatterns = [
    ...
    path('hospital/<str:hospital_id>/cases/', views.case_list, name="cases"),
    path('hospital/<str:hospital_id>/case/<int:case_id>/update',
         views.update_case, name="update_case"),
    path('hospital/<str:hospital_id>/case/create',
         views.create_case, name="create_case"),
    path('hospital/<str:hospital_id>/case/<int:case_id>/delete',
    ...
    path('hospital/<str:hospital_id>/case/<int:case_id>/opt-out',
         views.opt_out, name='opt_out'),
    path('hospital/<str:hospital_id>/case/<int:case_id>/submit',
         views.case_submit, name='case_submit'),
    path('hospital/<str:hospital_id>/cases/view_preference/<str:template_name>',
         views.view_preference, name='view_preference'),
    path('hospital/<str:hospital_id>/cases/hospital_select/<str:template_name>',
         views.child_hospital_select, name='child_hospital_select'),
    path('hospital/<str:hospital_id>/epilepsy12_users/<int:epilepsy12_user_id>/logs',
         views.logs, name='logs'),
    path('hospital/<str:hospital_id>/epilepsy12_users/<int:epilepsy12_user_id>/log_list',
         views.log_list, name='log_list'),
    path('selected_hospital_summary', views.selected_hospital_summary,
         name='selected_hospital_summary'),
    path('selected_trust/<str:hospital_id>/kpis', views.selected_trust_kpis,
         name='selected_trust_kpis'),
    path('selected_trust_kpis/<str:hospital_id>/select_kpi', views.selected_trust_select_kpi,
         name='selected_trust_select_kpi'),
    #     path('selected_trust_kpis/<str:hospital_id>/kpi/<str:kpi_name>', views.selected_trust_selected_kpi,
    #          name='selected_trust_selected_kpi'),
    path('hospital/<str:hospital_id>/case_statistics',
    ...
    path('hospital/<str:hospital_id>/epilepsy12_user_list/',
         views.epilepsy12_user_list, name='epilepsy12_user_list'),
    path('hospital/<str:hospital_id>/epilepsy12_users/create',
         views.create_epilepsy12_user, name='create_epilepsy12_user'),
    path('hospital/<str:hospital_id>/epilepsy12_users/<int:epilepsy12_user_id>/delete',
         views.delete_epilepsy12_user, name='delete_epilepsy12_user'),
    path('hospital/<str:hospital_id>/epilepsy12_users/<int:epilepsy12_user_id>/edit',
...
htmx_paths = [
    ...
    # epilepsy12_user
    path('hospital/<str:hospital_id>/filtered_epilepsy12_user_list', views.epilepsy12_user_list,
         name="filtered_epilepsy12_user_list"),
    path('hospital/<str:hospital_id>/epilepsy12_user/sort_epilepsy12_users_by_name_up', views.epilepsy12_user_list,
         name="sort_epilepsy12_users_by_name_up"),
    path('hospital/<str:hospital_id>/epilepsy12_user/sort_epilepsy12_users_by_name_down', views.epilepsy12_user_list,
         name="sort_epilepsy12_users_by_name_down"),
    path('hospital/<str:hospital_id>/epilepsy12_user/sort_epilepsy12_users_by_email_up', views.epilepsy12_user_list,
         name="sort_epilepsy12_users_by_email_up"),
    path('hospital/<str:hospital_id>/epilepsy12_user/sort_epilepsy12_users_by_email_down', views.epilepsy12_user_list,
         name="sort_epilepsy12_users_by_email_down"),
    path('hospital/<str:hospital_id>/epilepsy12_user/sort_epilepsy12_users_by_role_up', views.epilepsy12_user_list,
         name="sort_epilepsy12_users_by_role_up"),
    path('hospital/<str:hospital_id>/epilepsy12_user/sort_epilepsy12_users_by_role_down', views.epilepsy12_user_list,
         name="sort_epilepsy12_users_by_role_down"),
    path('hospital/<str:hospital_id>/epilepsy12_user/sort_epilepsy12_users_by_hospital_employer_up', views.epilepsy12_user_list,
         name="sort_epilepsy12_users_by_hospital_employer_up"),
    path('hospital/<str:hospital_id>/epilepsy12_user/sort_epilepsy12_users_by_hospital_employer_down', views.epilepsy12_user_list,
    ...
    path('htmx/sort_by_nhs_number_up/<str:hospital_id>', views.case_list,
         name="sort_by_nhs_number_up"),
    path('htmx/sort_by_nhs_number_down/<str:hospital_id>', views.case_list,
         name="sort_by_nhs_number_down"),
    path('htmx/sort_by_sex_up/<str:hospital_id>', views.case_list,
         name="sort_by_sex_up"),
    path('htmx/sort_by_sex_down/<str:hospital_id>', views.case_list,
         name="sort_by_sex_down"),
    path('htmx/sort_by_name_up/<str:hospital_id>', views.case_list,
         name="sort_by_name_up"),
    path('htmx/sort_by_name_down/<str:hospital_id>', views.case_list,
         name="sort_by_name_down"),
    path('htmx/sort_by_id_up/<str:hospital_id>', views.case_list,
         name="sort_by_id_up"),
    path('htmx/sort_by_id_down/<str:hospital_id>', views.case_list,
         name="sort_by_id_down"),
    path('htmx/sort_by_deadline_up/<str:hospital_id>', views.case_list,
         name="sort_by_deadline_up"),
    path('htmx/sort_by_deadline_down/<str:hospital_id>', views.case_list,
         name="sort_by_deadline_down"),
    path('htmx/sort_by_cohort_up/<str:hospital_id>', views.case_list,
         name="sort_by_cohort_up"),
    path('htmx/sort_by_cohort_down/<str:hospital_id>', views.case_list,
         name="sort_by_cohort_down"),
    path('htmx/sort_by_days_remaining_before_submission_up/<str:hospital_id>', views.case_list,
         name="sort_by_days_remaining_before_submission_up"),
    path('htmx/sort_by_days_remaining_before_submission_down/<str:hospital_id>', views.case_list,
