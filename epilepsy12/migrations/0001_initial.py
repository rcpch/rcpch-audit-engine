    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('case', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='epilepsy12.case', verbose_name='Related child/young person')),
                ('created_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='created%(app_label)s_%(class)s_related', to='auth.user', verbose_name='record created by user in %(class)')),
                ('locked_by', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='auth.user', verbose_name='The user who locked the registration from further data entry.')),
                ('updated_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='updated%(app_label)s_%(class)s_related', to='auth.user', verbose_name='record updated by user in %(class)')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('electroclinical_sydrome_other', models.CharField(default=None, max_length=250)),
                ('created_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='created%(app_label)s_%(class)s_related', to='auth.user', verbose_name='record created by user in %(class)')),
                ('updated_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='updated%(app_label)s_%(class)s_related', to='auth.user', verbose_name='record updated by user in %(class)')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='assessment',
            name='seizure_causes',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='epilepsy12.seizurecause', verbose_name='seizure causes'),
        ),
        migrations.AddField(
            model_name='assessment',
            name='updated_by',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('assessment', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='epilepsy12.assessment', verbose_name='related assessment')),
                ('created_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='created%(app_label)s_%(class)s_related', to='auth.user', verbose_name='record created by user in %(class)')),
                ('updated_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='updated%(app_label)s_%(class)s_related', to='auth.user', verbose_name='record updated by user in %(class)')),
            ],
            options={
