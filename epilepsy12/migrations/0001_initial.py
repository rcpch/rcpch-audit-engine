...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('description', models.CharField(default=None, help_text='What is the episode(s) like and is the description adequate?', max_length=500)),
                ('description_keywords', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(help_text='add a key word', max_length=100), blank=True, null=True, size=None)),
                ...
                ('epileptic_seizure_type', models.CharField(choices=[('FO', 'Focal onset'), ('GO', 'Generalised onset'), ('UO', 'Unknown onset'), ('UC', 'Unclassified')], max_length=3, verbose_name='If epileptic, what is the seizure type (s)?')),
                ...
                ('focal_onset_impaired_awareness', models.BooleanField(default=None)),
                ('focal_onset_automatisms', models.BooleanField(default=None)),
                ('focal_onset_atonic', models.BooleanField(default=None)),
                ('focal_onset_clonic', models.BooleanField(default=None)),
                ('focal_onset_left', models.BooleanField(default=None)),
                ('focal_onset_right', models.BooleanField(default=None)),
                ('focal_onset_epileptic_spasms', models.BooleanField(default=None)),
                ('focal_onset_hyperkinetic', models.BooleanField(default=None)),
                ('focal_onset_myoclonic', models.BooleanField(default=None)),
                ('focal_onset_tonic', models.BooleanField(default=None)),
                ('focal_onset_autonomic', models.BooleanField(default=None)),
                ('focal_onset_behavioural_arrest', models.BooleanField(default=None)),
                ('focal_onset_cognitive', models.BooleanField(default=None)),
                ('focal_onset_emotional', models.BooleanField(default=None)),
                ('focal_onset_sensory', models.BooleanField(default=None)),
                ('focal_onset_centrotemporal', models.BooleanField(default=None)),
                ('focal_onset_temporal', models.BooleanField(default=None)),
                ('focal_onset_frontal', models.BooleanField(default=None)),
                ('focal_onset_parietal', models.BooleanField(default=None)),
                ('focal_onset_occipital', models.BooleanField(default=None)),
                ('focal_onset_gelastic', models.BooleanField(default=None)),
                ('focal_onset_focal_to_bilateral_tonic_clonic', models.BooleanField(default=None)),
                ('focal_onset_other', models.BooleanField(default=None)),
                ...
                ('syndrome', models.CharField(max_length=50, verbose_name='Is there an identifiable epilepsy syndrome?')),
                ...
                ('relevant_impairments_behavioural_educational', models.BooleanField(max_length=50, verbose_name='Are there any relevant impairments: behavioural or educational, emotional problems?')),
            ],
            options={
