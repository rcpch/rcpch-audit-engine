...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name="HistoricalEpilepsyCauseEntity",
            fields=[
                (
                    "id",
                    models.BigIntegerField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("cohort", models.PositiveSmallIntegerField(default=None)),
                ("final_publication", models.BooleanField(default=False)),
                ("abstraction_relation", models.CharField(max_length=100, unique=True)),
            ],
            options={
        ...
        migrations.AddField(
            model_name="historicalmedicineentity",
            name="created_by",
            field=models.ForeignKey(
                blank=True,
                db_constraint=False,
        ...
        migrations.AddField(
            model_name="historicalepilepsycauseentity",
            name="created_by",
            field=models.ForeignKey(
                blank=True,
                db_constraint=False,
        ...
        migrations.AddField(
            model_name="epilepsycauseentity",
            name="created_by",
            field=models.ForeignKey(
                null=True,
                on_delete=django.db.models.deletion.CASCADE,
        ...
        migrations.AddIndex(
            model_name="country",
            index=models.Index(
                fields=["ctry22cd"], name="epilepsy12__ctry22c_6c03f3_idx"
            ),
        ),
        migrations.AddField(
        ...
        migrations.AddIndex(
            model_name="organisation",
            index=models.Index(
                fields=["OrganisationName"], name="epilepsy12__Organis_7e589c_idx"
            ),
        ),
        migrations.AddField(
