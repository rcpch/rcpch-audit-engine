# Generated by Django 4.0 on 2022-04-24 20:37
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('epilepsy_surgery_centre', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='epilepsy_surgical_centre', to='epilepsy12.hospitaltrust')),
                ('lead_hospital', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='general_paediatric_hospital', to='epilepsy12.hospitaltrust')),
                ('tertiary_paediatric_neurology_centre', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='tertiary_paediatric_neurology_centre', to='epilepsy12.hospitaltrust')),
            ],
            options={
