    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('epilepsy_status', models.CharField(choices=[(0, 'epilepsy'), (1, 'nonepilepsy'), (2, 'unknown')], max_length=1, verbose_name='Is the episode(s) epileptic? Is this epilepsy?')),
                ('seizure_type', models.CharField(max_length=50, verbose_name='If epileptic, what is the seizure type (s)?')),
                ('syndrome', models.CharField(max_length=50, verbose_name='Is there an identifiable epilepsy syndrome?')),
                ('cause', models.CharField(max_length=50, verbose_name='What is the cause of this epilepsy and what further investigations may be needed to explore this?')),
