# Generated by Django 4.1.1 on 2022-09-10 15:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('case', models.ManyToManyField(to='epilepsy12.case')),
                ('created_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='craeted_%(class)s', to=settings.AUTH_USER_MODEL, verbose_name='record created by user in %(class)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('referring_clinician', models.CharField(max_length=50, null=True)),
