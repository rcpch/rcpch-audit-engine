# Generated by Django 4.0.4 on 2022-06-02 14:30
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('description', models.CharField(blank=True, default=None, help_text='What is the episode(s) like and is the description adequate?', max_length=5000, null=True)),
                ...
                ('epilepsy_or_nonepilepsy_status', models.CharField(blank=True, choices=[('E', 'Epilepsy'), ('NE', 'Non-epilepsy'), ('U', 'Uncertain')], default='E', max_length=3, verbose_name='Is a diagnosis of epilepsy definite, or uncertain.')),
                ('epileptic_seizure_onset_type', models.CharField(choices=[('FO', 'Focal onset'), ('GO', 'Generalised onset'), ('UO', 'Unknown onset'), ('UC', 'Unclassified')], default='FO', max_length=3, verbose_name='If epileptic, what is the seizure type (s)?')),
                ...
                ('focal_onset_impaired_awareness', models.BooleanField(blank=True, default=False, null=True)),
                ('focal_onset_automatisms', models.BooleanField(blank=True, default=False, null=True)),
                ('focal_onset_atonic', models.BooleanField(blank=True, default=False, null=True)),
                ('focal_onset_clonic', models.BooleanField(blank=True, default=False, null=True)),
                ('focal_onset_left', models.BooleanField(blank=True, default=False, null=True)),
                ('focal_onset_right', models.BooleanField(blank=True, default=False, null=True)),
                ('focal_onset_epileptic_spasms', models.BooleanField(blank=True, default=False, null=True)),
                ('focal_onset_hyperkinetic', models.BooleanField(blank=True, default=False, null=True)),
                ('focal_onset_myoclonic', models.BooleanField(blank=True, default=False, null=True)),
                ('focal_onset_tonic', models.BooleanField(blank=True, default=False, null=True)),
                ('focal_onset_autonomic', models.BooleanField(blank=True, default=False, null=True)),
                ('focal_onset_behavioural_arrest', models.BooleanField(blank=True, default=False, null=True)),
                ('focal_onset_cognitive', models.BooleanField(blank=True, default=False, null=True)),
                ('focal_onset_emotional', models.BooleanField(blank=True, default=False, null=True)),
                ('focal_onset_sensory', models.BooleanField(blank=True, default=False, null=True)),
                ('focal_onset_centrotemporal', models.BooleanField(blank=True, default=False, null=True)),
                ('focal_onset_temporal', models.BooleanField(blank=True, default=False, null=True)),
                ('focal_onset_frontal', models.BooleanField(blank=True, default=False, null=True)),
                ('focal_onset_parietal', models.BooleanField(blank=True, default=False, null=True)),
                ('focal_onset_occipital', models.BooleanField(blank=True, default=False, null=True)),
                ('focal_onset_gelastic', models.BooleanField(blank=True, default=False, null=True)),
                ('focal_onset_focal_to_bilateral_tonic_clonic', models.BooleanField(blank=True, default=False, null=True)),
                ('focal_onset_other', models.BooleanField(blank=True, default=False, null=True)),
                ('focal_onset_other_details', models.CharField(blank=True, default='', max_length=250, null=True)),
                ('epileptic_generalised_onset', models.CharField(blank=True, choices=[('TCl', 'Tonic-clonic'), ('Clo', 'Clonic'), ('Ton', 'Tonic'), ('MyC', 'Myoclonic'), ('MTC', 'Myoclonic-tonic-clonic'), ('MAt', 'Myoclonic-atonic'), ('Ato', 'Atonic'), ('EpS', 'Epileptic spasms'), ('TAb', 'Typical absence'), ('Aab', 'Atypical absence'), ('MAb', 'Myoclonic absence'), ('AEM', 'Absence with eyelid myoclonia'), ('Oth', 'Other')], default=None, max_length=3, null=True)),
                ('epileptic_generalised_onset_other_details', models.CharField(blank=True, default=None, max_length=250, null=True)),
                ...
                ('nonepileptic_seizure_unknown_onset_other_details', models.CharField(blank=True, default=None, max_length=250, null=True)),
                ...
                ('seizure_cause_main_snomed_code', models.CharField(blank=True, choices=[('Str', 'Structural'), ('Gen', 'Genetic'), ('Inf', 'Infectious'), ('Met', 'Metabolic'), ('Imm', 'Immune'), ('NK', 'Not known')], default=None, max_length=3, null=True, verbose_name='SNOMED-CT code for main identified cause of seizure(s)')),
                ('seizure_cause_structural', models.CharField(blank=True, choices=[('TbS', 'Tuberous Sclerosis'), ('StW', 'Sturge Weber'), ('FCD', 'Focal cortical dysplasia'), ('HyH', 'Hypothalamic Hamartoma'), ('LGT', 'Low grade tumour'), ('TuO', 'Tumour (other)'), ('MCD', 'Malformations of Cortical Development'), ('Vas', 'Vascular (eg arterial ischaemic stroke venous ischaemia cerebral haemorrhage)'), ('TBI', 'Traumatic brain injury'), ('NR', 'Not required')], default=None, max_length=3, null=True, verbose_name='main identified structural cause of seizure(s)')),
                ('seizure_cause_structural_snomed_code', models.CharField(blank=True, choices=[('TbS', 'Tuberous Sclerosis'), ('StW', 'Sturge Weber'), ('FCD', 'Focal cortical dysplasia'), ('HyH', 'Hypothalamic Hamartoma'), ('LGT', 'Low grade tumour'), ('TuO', 'Tumour (other)'), ('MCD', 'Malformations of Cortical Development'), ('Vas', 'Vascular (eg arterial ischaemic stroke venous ischaemia cerebral haemorrhage)'), ('TBI', 'Traumatic brain injury'), ('NR', 'Not required')], default=None, max_length=3, null=True, verbose_name='SNOMED-CT code for main identified structural cause of seizure(s)')),
                ('seizure_cause_genetic', models.CharField(blank=True, choices=[('DrS', 'Dravet syndrome'), ('GTD', 'Glucose Transporter Defect'), ('AnS', 'Angelman Syndrome'), ('ReS', 'Rett Syndrome'), ('ChA', 'Chromosomal abnormality'), ('GeA', 'Gene abnormality')], default=None, max_length=3, null=True, verbose_name='main identified genetic cause of seizure(s)')),
                ...
                ('seizure_cause_gene_abnormality_snomed_code', models.CharField(blank=True, default=None, max_length=50, null=True, verbose_name='SNOMED-CT code for main identified genetic cause of seizure(s)')),
                ...
                ('seizure_cause_infectious_snomed_code', models.CharField(blank=True, default=None, max_length=250, null=True, verbose_name='SNOMED-CT code for main identified infectious cause of seizure(s)')),
                ...
                ('seizure_cause_metabolic_snomed_code', models.CharField(blank=True, default=None, max_length=250, null=True, verbose_name='SNOMED-CT code for other identified metabolic cause of seizure(s) not previously specified.')),
                ...
                ('seizure_cause_immune_antibody', models.CharField(blank=True, choices=[('VGK', 'VGKC'), ('NMD', 'NMDAR'), ('GAD', 'GAD'), ('TPO', 'TPO'), ('MOG', 'MOG'), ('Oth', 'Other')], default=None, max_length=3, null=True, verbose_name='autoantibody identified as cause of seizure(s).')),
                ...
                ('seizure_cause_immune_snomed_code', models.CharField(blank=True, default=None, max_length=250, null=True, verbose_name='SNOMED-CT code for main identified immune cause of seizure(s).')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lead_hospital', models.CharField(default=None, max_length=100, null=True, verbose_name='lead_hospital')),
                ('tertiary_paediatric_neurology_centre', models.CharField(default=None, max_length=100, verbose_name='tertiary_paediatric_neurology_centre')),
                ('epilepsy_surgery_centre', models.CharField(max_length=100, null=True, verbose_name='epilepsy_surgery_centre')),
        ...
        migrations.AddField(
            model_name='case',
            name='locked_by',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='locked by'),
        ),
        migrations.AddField(
