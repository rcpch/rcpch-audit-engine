# Generated by Django 4.0 on 2022-03-16 22:13
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('index_of_multiple_deprivation_quintile', models.PositiveSmallIntegerField(blank=True, editable=False, verbose_name='index of multiple deprivation calculated from MySociety data.')),
                ('locked_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='auth.user', verbose_name='locked by')),
            ],
            options={
                'verbose_name': 'case',
